...
public class Step4Controller {
  ...
  public String index(Comment comment, Model model) {
    ...
    studentList.add(new Student("321A0001", "山田 太郎", "ケータイ・アプリケーション"));
    studentList.add(new Student("321A0002", "田中 一郎", "ケータイ・アプリケーション"));
    studentList.add(new Student("321A0003", "佐藤 次郎", "ケータイ・アプリケーション"));
    // 課題 level2 step4
    // 所属学科を追加してください。
